...
<html>
    ...
    <body>
        ...
        <div class="authenticate_nav_bar">
            <ul>
                <li><a href="../pages/authentication_password.php" class="active">Password-Based</a></li>
        ...
        <div class="authenticate_password">
            <p>Password-based authentication are one of the most commonly used methods of authenticating a person's 
                identity due to its simplicity and low cost. Enter the username and password and click submit!</p>
            <br>
